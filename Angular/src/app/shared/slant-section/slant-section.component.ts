...
export class SlantSectionComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit(): void {
        const cont_main = this.cont_main.nativeElement;
        const cont_in_1 = this.cont_in_1.nativeElement;
        const cont_in_2 = this.cont_in_2.nativeElement;
        const button_style = this.button_style.nativeElement;
