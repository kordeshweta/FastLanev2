...
export class HeaderComponent implements OnInit, AfterViewInit{
    ...
    ngOnInit(): void {
        this.dropdownArray = [];
        const dropdown = dropdown_array.default;
    ...
    ngAfterViewInit() {
        ...
        window.addEventListener('resize', function(event) {
            const element1 = document.getElementsByClassName('container-1');
            const element2 = document.getElementsByClassName('container-1')[0].nextElementSibling.getBoundingClientRect();
