...
export class ComponentServicesService {
    ...
    getComponentData(practices): Observable<any[]> {
        const component = this.http.get(`${environment.apiUrl}components`);
        const solutions = this.http.get(`${environment.apiUrl}solutions`);
        const bestPractices = this.http.get(`${environment.apiUrl}bestPractices`);
